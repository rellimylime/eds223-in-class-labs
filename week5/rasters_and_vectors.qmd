...
```{r}
# Mask raster based on object
# Note: Cells outside of vector are converted to NA
...
# Note: cells inside of vector are converted to NA
...
# Convert those high elevation values into polygons and tranform into simple features
...
# Reduce the size by 1/4 for processing speed purposes
...
bryce_small %>% 
  ...
  # Add texture shading, emphasizing ridges
