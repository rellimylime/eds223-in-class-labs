...
```{r}
dtm_pre <- rast(here::here( "week9", "Eaton-20251125T160259Z-1-001", "Eaton", "dtm_eaton_alignedNK_1m_PREFIRE.tif"))
dsm_pre <- rast(here::here( "week9", "Eaton-20251125T160259Z-1-002", "Eaton", "dsm_eaton_alignedNK_1m_PREFIRE.tif"))
  
  
dtm_post <- rast(here::here( "week9", "Eaton-20251125T160259Z-1-001", "Eaton", "dsm_eaton_epsg32611_geoid12b_1m_POSTFIRE.tif"))
dsm_post <- rast(here::here( "week9", "Eaton-20251125T160259Z-1-002", "Eaton", "dtm_eaton_epsg32611_geoid12b_1m_POSTFIRE.tif"))
```

```{r}
damage <- st_read(here::here("week9","06061784-f911-4d0e-aca5-0768ac66aac5.gdb-20251125T160256Z-1-001","06061784-f911-4d0e-aca5-0768ac66aac5.gdb")) %>% st_transform(crs = crs(dsm_post))
```


```{r}

eaton_perimeter <- st_read(here::here( "week9", "Eaton_Perimeter_20250121.shp"))%>% st_transform(crs = crs(dsm_post))
```
...
# Remove values outside of upper and lower quantiles
...
ggplot(damage_plot, aes(age_category, elevation_loss, fill = age_category)) +
  ...
  coord_flip() + # Put year on y and elev loss on x
  labs(
